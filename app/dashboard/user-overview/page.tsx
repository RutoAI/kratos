    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-3 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
            <div className="w-full flex justify-between">
                        <h3 className="text-sm text-gray-400 mb-2">Total Customers</h3>
                        <img src="/svg/block.svg" alt="" />
            </div>
            <p className="text-3xl font-bold text-white mb-1">12,040</p>
            <p className="text-xs text-gray-500">+ 6.5% Since last week</p>
          </div>
          ...
          <div className="p-4 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
          <div className="w-full flex justify-between">
                        <h3 className="text-sm text-gray-400 mb-2">Daily Active Users</h3>
                        <img src="/svg/block.svg" alt="" />
            </div>
            <p className="text-3xl font-bold text-white mb-1">89,432</p>
            <p className="text-xs text-gray-500">+ 8.2% from</p>
          </div>
  
          <div className="p-4 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
          <div className="w-full flex justify-between">
                        <h3 className="text-sm text-gray-400 mb-2">Total Adminsitrative Users</h3>
                        <img src="/svg/block.svg" alt="" />
            </div>
            <p className="text-3xl font-bold text-white mb-1">178</p>
            <p className="text-xs text-gray-500">Currently Active: 20</p>
          </div>
        </div>
